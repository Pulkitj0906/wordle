          ...
          className={`
            ...
            `}>
                <div
                      ...
                      p-5
                      rounded-t">
                          <h3 className="text-3xl font-semibold dark:text-slate-300">Also Visit</h3>
                          <button
                              onClick={sidebar.OnClose}
                              className="
                          p-1
                ...
                <a href="https://www.nytimes.com/games/wordle/index.html" target="_blank" rel="noopener noreferrer">
                    <div className=" p-1 rounded-md dark:hover:bg-neutral-700 hover:bg-slate-200 hover:cursor-pointer flex flex-row items-center justify-between">
                        <Image alt='' className="h-4 w-4 ml-3" height={40} width={40} src='/images/wordlelogo.png' />
                        <p className="dark:text-slate-200">Actual Wordle</p>
                    </div>
                </a>
                ...
                <a href="https://messenger-three-bay.vercel.app/" target="_blank" rel="noopener norefferer">
                    <div className=" p-1 rounded-md dark:hover:bg-neutral-700 hover:bg-slate-200 hover:cursor-pointer flex flex-row items-center justify-between">
                        ...
                        <p className="dark:text-slate-200">Slatexter(Messenger Clone)</p>
                    </div>
                </a>
                <hr className="dark:opacity-40" />
            </div>
            <div className="p-3">
                <a href="https://twitterc-nu.vercel.app/" target="_blank" rel="noopener norefferer">
                    <div className=" p-1 rounded-md dark:hover:bg-neutral-700 hover:bg-slate-200 hover:cursor-pointer flex flex-row items-center justify-between">
                        ...
                        <p className="dark:text-slate-200">Slater(Twitter Clone)</p>
                    </div>
                </a>
                <hr className="dark:opacity-40" />
            </div>
            <div className="p-3 pb-0">
                <a href="https://slatestay.onrender.com/" target="_blank" rel="noopener norefferer">
                    <div className=" p-1 rounded-md dark:hover:bg-neutral-700 hover:bg-slate-200 hover:cursor-pointer flex flex-row items-center justify-between">
                        ...
                        <p className="dark:text-slate-200">SlateStay</p>
                    </div>
                </a>
                <hr className="dark:opacity-40" />
            </div>
                <div className="p-2 flex top-1 justify-center flex-row relative dark:text-slate-200">
                    <p className="">Created by: Pulkit Jain</p>
                    <div className="absolute inset-x-0 top-0 h-2 bg-gradient-to-b from-transparent dark:to-neutral-900 to-neutral-200"></div>
                </div>
            </div>
        </div>
  )
